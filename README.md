...
### 3）在 GitHub 创建空仓库后绑定远程

把下面的地址替换成你自己的：

```bash
git remote add origin https://github.com/<your-name>/judgelab.git
git branch -M main
...
- `LICENSE`：决定别人能不能用、怎么用你的代码
- GitHub 仓库简介和 Topics
- 发布截图或演示 GIF
- 版本说明（后续有多人协作时再补也行）

如果你只是先把项目传上去，`README + .gitignore` 已经够用了。
